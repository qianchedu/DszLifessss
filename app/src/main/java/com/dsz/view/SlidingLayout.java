...
public class SlidingLayout extends LinearLayout implements OnTouchListener {
	 ...
	 */
	private int leftLayoutPadding = 110;
	...
	public SlidingLayout(Context context, AttributeSet attrs) {
		...
		leftLayoutPadding = screenWidth/3;
	}
	 ...
	 * AbsoluteLayout已被弃用。
	 * 
	 * @return 如果绑定滑动事件的View是view的子类
	 *         TableLayout之一就返回true，否则返回false。
	 */
	private boolean isBindBasicLayout(View view) {
		if (view == null) {
			return false;
		}
